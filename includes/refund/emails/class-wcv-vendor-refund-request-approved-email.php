...
class WCV_Vendor_Refund_Request_Approved_Email extends WC_Email {
	...
	public function __construct() {
		...
		$this->title       = __( 'Refund request approved', 'wc-vendors-gateway-stripe-connect' );
		$this->description = __( 'This email notify vendors when their requests are approved.', 'wc-vendors-gateway-stripe-connect' );

		// Default settings.
		$this->heading = __( 'Refund request has been approved.', 'wc-vendors-gateway-stripe-connect' );
		$this->subject = __( 'Refund request has been approved', 'wc-vendors-gateway-stripe-connect' );
